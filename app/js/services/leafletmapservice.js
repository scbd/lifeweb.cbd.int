  ...
  app.factory('leafletMapService', [ '$http',"realm", "commonjs", function($http, realm,  commonjs) {
         ...
         //============================================================
          var generateMap = function(q) {
              ...
              '&rows=500&sort=createdDate_dt+desc,+title_t+asc&start=0&wt=json&fl=identifier_s,budgetCost_ds,donatioFunding_ds,title_s,country_ss,createdDate_s,funding_status,identifier_s,'+

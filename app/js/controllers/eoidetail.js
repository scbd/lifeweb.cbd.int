define(['app', 'app/js/controllers/map.js', 'authentication', 'URI', 'leaflet', 'controllers/page', 'editFormUtility',
    '/app/js/services/filters/linkify.js', '/app/js/services/filters/thumbnail.js', '/app/js/directives/campaign.js',
], function(app, map) {
    ...
    app.controller('EOIDetailCtrl', function($scope, $http, $q, $modal, editFormUtility, $anchorScroll, location) {
        ...
        $scope.countries = [];
        var countriesPromise = $http.get('/api/v2013/thesaurus/domains/countries/terms', {
            cache: true
        }).then(function(data) {
    ...
    app.filter('roleFilter', function($filter) {
        return function(r) {
            var roles = [{
                ...
                identifier: 'community_engagement',
            }, {
